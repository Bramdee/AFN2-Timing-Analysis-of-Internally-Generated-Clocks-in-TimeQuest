...
module  EnabledClk_altclkctrl_0_sub
	( 
	ena,
	inclk,
...
`endif
	...
	assign
		clkselect = {2{1'b0}},
		outclk = wire_sd1_outclk;
endmodule //EnabledClk_altclkctrl_0_sub
...
`timescale 1 ps / 1 ps
// synopsys translate_on
module  EnabledClk_altclkctrl_0  (
    ena,
    inclk,
    outclk);
...
`endif
    ...
    EnabledClk_altclkctrl_0_sub  EnabledClk_altclkctrl_0_sub_component (
                .ena (ena),
                .inclk (sub_wire2),
                .outclk (sub_wire0));
